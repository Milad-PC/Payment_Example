function AddPayment(price, descriprion){
...
function ShowMain(){
    ...
    var div = document.getElementById('listofwork');
    lists.forEach(element => {
        console.log(element);
            var divpad = document.createElement("div");
            divpad.classList.add("row");
            divpad.classList.add("work");
                var divrow = document.createElement("div");
                divrow.classList.add("work-wrap");
                divrow.classList.add("row");
                    var divcol10 = document.createElement("div");
                    divcol10.classList.add("col-10");
                        var itemlink = document.createElement("a");
                        itemlink.innerHTML = "<h5>&#127968; " + element + "</h5>";
                        itemlink.href="list.html";
                    divcol10.append(itemlink);
                divrow.appendChild(divcol10);
                    var divcol2 = document.createElement("div");
                    
                    divcol2.classList.add("col-2");
                    divcol2.innerHTML = `<button onclick="DelFromLists('${element}')"><p>&#10060;</p></button>`;
                divrow.appendChild(divcol2);
            divpad.appendChild(divrow);
        div.appendChild(divpad);
    });
}
